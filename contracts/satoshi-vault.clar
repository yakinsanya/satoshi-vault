...
;; Borrow against your BTC without selling-maintain sovereignty and upside potential.
;;
;; Description:
;; SatoshiVault enables Bitcoin holders to access instant liquidity through
;; trustless overcollateralization on Stacks. Deposit BTC as collateral, borrow
;; stablecoins at competitive rates, and retain full ownership until loan closure.
;; Smart liquidation mechanisms protect protocol integrity while preserving user autonomy.
;;
